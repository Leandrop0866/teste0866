...
<h5>Creditos:<span class="badge badge-dark float-right saldo">@JV086</span></h5>
                  </div> 
                </div>
              </div>
...
Swal.fire({ title: "AVISO", text: " Limite de 500 linhas ", icon: "warning", confirmButtonText: "OK", buttonsStyling: false, confirmButtonClass: 'btn btn-primary'});
